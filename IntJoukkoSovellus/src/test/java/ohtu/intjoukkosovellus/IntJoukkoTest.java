...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.sijainti(10) > -1);
        assertFalse(joukko.sijainti(5) > -1);
        assertTrue(joukko.sijainti(3) > -1);
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.sijainti(3) > -1);
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.sijainti(11) > -1);
        joukko.poista(11);
        assertFalse(joukko.sijainti(11) > -1);
    ...
    public void joukonKapasiteettiEiSaaOllaNegatiivinen() {
        joukko = new IntJoukko(-1);
    }
    
    @Test(expected = IndexOutOfBoundsException.class)
    public void joukonKapasiteettiEiSaaOllaNegatiivinen2() {
        joukko = new IntJoukko(-1, 2);
    }
    
    @Test(expected = IndexOutOfBoundsException.class)
    public void joukonKasvatuskokoEiSaaOllaNegatiivinen() {
        joukko = new IntJoukko(1, -2);
    }
}
